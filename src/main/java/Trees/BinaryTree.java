...
public class BinaryTree<T> implements Tree<T> {
    ...
    private boolean delete(BinaryTreeNode<T> root, T targetValue) {
        ...
        if (root.left.element == null && root.right.element == null) {
            if (root.element.equals(targetValue)) {
                root.element = null;
                return true;
            } else {
                return false;
        ...
        while (!queue.isEmpty()) {
            ...
            if (deepestNode.element.equals(targetValue)) {
    ...
    private static class BinaryTreeNode<S>{
        ...
        S getElement(){return element;}

        BinaryTreeNode<S> getLeft(){return left;}

        BinaryTreeNode<S> getRight(){return right;}
    }
}
